...
export class QRScannerRectView extends Component {
  static propTypes = {
    ...
    scanmaskColor: PropTypes.string,
  ...
  static defaultProps = {
    maskColor: "#fff",
    scanmaskColor: "rgba(0,0,0,0.0.16)",
    cornerOffsetSize: 0,
    isShowScanBar: true,
    isShowCorner: true,
    showScan: true,
  ...
  getBackgroundColor = () => {
    if (this.props.showScan)
      return { backgroundColor: this.props.scanmaskColor };
    else return { backgroundColor: this.props.maskColor };
  };
  ...
  render() {
    ...
    const { borderWidth, borderRadius } = this.innerCornerStyle;
  ...
  render() {
    ...
    return (
      <Camera
        ...
        onBarCodeScanned={this.onScanResult}
        type={
          userFront ? Camera.Constants.Type.front : Camera.Constants.Type.back
        }
        flashMode={
          torchOn
